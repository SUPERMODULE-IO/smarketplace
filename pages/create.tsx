      ...
      <div className={styles.container}>
        ...
        <div className={styles.collectionContainer}>
          <h1 className={styles.ourCollection}>
            Upload your NFT to the Supermodule marketplace:
          </h1>
          ...
          <button
            type="submit"
            className="font-bold items-center bg-primary2 border-0 py-2 px-6 focus:outline-none hover:bg-primary1  rounded  text-gray-100 flex"
